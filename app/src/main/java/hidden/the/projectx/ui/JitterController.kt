 ...
 * Menyeleksi tab terakhir yang dipilih secara otomatis saat dibuka kembali.
 */
class JitterController(
    ...
    companion object {
        ...
        private var lastSelectedId: String = Targets.GRAB.id
    }
    ...
    fun show() {
        ...
        // Gunakan posisi tab terakhir yang tersimpan di memori
        var selectedId = lastSelectedId
        ...
        segGrab.setOnClickListener {
            ...
            lastSelectedId = Targets.GRAB.id // SIMPAN TAB GRAB
            syncAll()
            toast("Menyetel: GRAB")
        }
        segGojek.setOnClickListener {
            ...
            lastSelectedId = Targets.GOJEK.id // SIMPAN TAB GOJEK
            syncAll()
